...
public:
	...
	template<typename T,typename test=typename std::enable_if<
		std::is_same<typename std::remove_cv<typename std::remove_reference<decltype((new typename std::remove_reference<T>::type[1])[0][0])>::type>::type,char>::value&&
		!std::is_same<typename std::remove_cv<typename std::remove_reference<T>::type>::type,unique_string>::value
	>::type>
	...
	typename std::enable_if<
		std::is_same<typename std::remove_cv<typename std::remove_reference<T>::type>::type,unique_string>::value, int
